...
@section('content')
    <div class="columns">
        ...
        <div class="column">
            <h1 class="title">{{ $binder->name }} People
                <a href="{{ route('binders.people.create', $binder) }}" class="is-size-6">
                    <span class="icon">
            ...
            @unless($binder->people->count())
                There are no People added to this Binder yet!
            @endunless
