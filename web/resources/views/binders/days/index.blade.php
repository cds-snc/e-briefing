...
@section('content')
    <div class="columns">
        ...
        <div class="column">
            <h1 class="title">{{ $binder->name }} Itinerary
                <a href="{{ route('binders.days.create', $binder) }}" class="is-size-6">
                    <span class="icon">
            ...
            @unless($binder->days->count())
                There are no Days added to this Binder yet!
            @endunless

            @if($binder->days->count())
                <table class="table">
                    <tr>
                        <th>Day</th>
                        <th>Date</th>
